...
jQuery(function ($){
	...
	//Eventos
		$.validator.addMethod("defaultInvalid", function(value, element) 
	    {
  		...
  		var $validator = $("#consultant-node-form").validate({
		  rules: {
			//Datos 1
			//"title":"required ",
			"field_consultant_name[und][0][value]":"required",
			"field_consultant_email[und][0][value]":{required: true,email:true},			
						
		  },
		  messages:{
			//Datos radicador
			//"title":"Dato obligatorio",
			"field_consultant_name[und][0][value]":"This field is required",
			"field_consultant_email[und][0][value]":"This field is required, please enter a valid email address",					
		  },
